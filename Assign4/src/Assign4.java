 ...
 *
 * This class runs out computations for calculating pi and 1000 digits after the decimal
 */
...
//        System.out.printf("Number of cpus: %d\n", Runtime.getRuntime().availableProcessors());
        ...
        try {
            ...
            // This for loop to display pi doesn't need to be here, but it says to print the time after and it won't work unless in the try block
